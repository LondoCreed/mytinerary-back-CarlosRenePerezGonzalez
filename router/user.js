...
routerUsers.put('/updateById/:id',passport.authenticate('jwt',{session:false}),update)
routerUsers.delete('/deleteUserById/:id',passport.authenticate('jwt',{session:false}),deleteUser)
